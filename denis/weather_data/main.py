...
def get_weather_monthly_stats(latitude: float, longitude: float, year: int, month: int):
    ...
    monthly_avg = df[['temp_max', 'temp_min', 'precipitation', 'wind_speed_max']].mean().to_dict()
    result = {
...
def create_new_weather_columns(df, max_retries=3, retry_delay=5, succes_delay=0.02, cache_path='denis/cache/weather_cache.pkl'):
